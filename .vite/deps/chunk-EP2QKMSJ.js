...
var React9, import_prop_types5, import_jsx_runtime3, GlobalStyles_default;
...
var React10, import_jsx_runtime4;
...
var React13, import_prop_types7, import_jsx_runtime5, ThemeProvider_default;
...
var React14, import_prop_types8, import_jsx_runtime6, RtlContext, useRtl, RtlProvider_default;
var init_RtlProvider = __esm({
  "node_modules/@mui/system/RtlProvider/index.js"() {
    React14 = __toESM(require_react());
    import_prop_types8 = __toESM(require_prop_types());
    import_jsx_runtime6 = __toESM(require_jsx_runtime());
    RtlContext = React14.createContext();
...
var React15, import_prop_types9, import_jsx_runtime7, PropsContext, DefaultPropsProvider_default;
var init_DefaultPropsProvider = __esm({
  "node_modules/@mui/system/DefaultPropsProvider/DefaultPropsProvider.js"() {
    ...
    PropsContext = React15.createContext(void 0);
...
var React16, import_prop_types10, import_jsx_runtime8, EMPTY_THEME, ThemeProvider_default2;
...
var React17, import_jsx_runtime9, DEFAULT_MODE_STORAGE_KEY, DEFAULT_COLOR_SCHEME_STORAGE_KEY, DEFAULT_ATTRIBUTE;
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React19.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime10.jsx)(React19.Fragment, {
        children: (((_b = theme.generateStyleSheets) == null ? void 0 : _b.call(theme)) || []).map((styles, index) => (0, import_jsx_runtime10.jsx)(GlobalStyles, {
          styles
        }, index))
...
var React19, import_prop_types11, import_jsx_runtime10, DISABLE_CSS_TRANSITION;
...
function prepareCssVars(theme, {
  ...
  const generateStyleSheets = () => {
    ...
    insertStyleSheet((getSelector == null ? void 0 : getSelector(void 0, {
      ...rootCss
    })) || ":root", rootCss);
    const {
    ...
    if (defaultSchemeVal) {
      ...
      insertStyleSheet((getSelector == null ? void 0 : getSelector(colorScheme, {
        ...css2
      })) || `[${theme.attribute || "data-color-scheme"}="${colorScheme}"]`, css2);
    }
    Object.entries(rest).forEach(([key, {
      ...
      insertStyleSheet((getSelector == null ? void 0 : getSelector(key, {
        ...css2
      })) || `[${theme.attribute || "data-color-scheme"}="${key}"]`, css2);
    });
    return stylesheets;
  };
  return {
...
var React20, import_prop_types12, import_jsx_runtime11, defaultTheme, defaultCreateStyledComponent, useThemePropsDefault, useUtilityClasses;
...
var React21, import_prop_types14, import_jsx_runtime12, defaultTheme2, defaultCreateStyledComponent2;
...
var React22, import_prop_types16, import_jsx_runtime13, defaultTheme3, defaultCreateStyledComponent3, getSideFromDirection, style3;
...
@mui/styled-engine/index.js:
  (**
   * @mui/styled-engine v6.0.0-alpha.14
   *
   * @license MIT
   * This source code is licensed under the MIT license found in the
   * LICENSE file in the root directory of this source tree.
...
@mui/private-theming/index.js:
  (**
   * @mui/private-theming v6.0.0-alpha.14
   *
   * @license MIT
   * This source code is licensed under the MIT license found in the
   * LICENSE file in the root directory of this source tree.
...
@mui/system/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EP2QKMSJ.js.map
